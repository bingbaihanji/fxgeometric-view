...
public class EllipseGeo extends AbstractWorldObject {
     ...
     */
    public double getC() {
        return Math.hypot(getF2x() - getF1x(), getF2y() - getF1y()) / 2.0;
    }
    ...
    public double getRotationAngle() {
        return Math.atan2(getF2y() - getF1y(), getF2x() - getF1x());
    }

    public PointGeo getF1Ref() {
        return focus1.getRef();
    }

    public PointGeo getF2Ref() {
        return focus2.getRef();
    }
